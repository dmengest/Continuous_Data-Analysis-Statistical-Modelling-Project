...
proc reg data=cent_train;
	...
	*#####################################;
	%let reg_x= white income veterans firms inthouseholdeducation intwhiteeducation intincomefirms intwhitehousehold intincomehousehold intincomegender inteducationveterans intwhitefirms intfirmsveterans;
...
%let reg_x= white income veterans firms inthouseholdeducation intwhiteeducation intincomefirms intincomehousehold intincomegender inteducationveterans intwhitefirms;
